    ...
    <div className="mt-8" id="agenda">
      ...
      <div className="items-center">
        <div className="text-4xl md:text-6xl self-center text-center my-8">
          <span className="font-bold">Catalyzing</span> the DAO Forum <span className="font-bold">mission</span> and <span className="font-bold">community</span>
        </div>
        <div className="font-nunito flex flex-col justify-center text-center self-center items-center text-xl md:text-2xl pb-32 lg:pb-80 bg-[url('../public/BALL.svg')] border-b-2 border-black">
          <p>Workshops on the DAO Forum DAO mission and governance DAOversity; Diversity, inclusion, equity and accessibility</p>
          <br/>
      ...
      <div className="self-center text-xl md:text-3xl lg:text-4xl font-nunito text-center">
        FIVE KEY STREAMS FOR <span className="font-extrabold">DAO Forum</span> DISCUSSION
      </div>
      <div className="flex flex-col self-center gap-4 p-10 bg-[url('../public/plan_bg.svg')] bg-cover bg-no-repeat">
        ...
        <div className="md:w-1/2 self-center text-xl font-nunito my-12">
          The DAO Forum community is deeply committed to the principles of diversity, inclusion, transparency, privacy and decentralisation, and these values will be reflected in our conversations and our actions as a collective. See here for the 2023 draft agenda.
        </div>
        <a
