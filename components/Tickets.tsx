    ...
    return (
      <div className="flex justify-center self-center text-center hover:cursor-pointer">
        ...
        <div className="w-[100px] h-[130px] md:h-[180px] md:w-[100px] bg-[#E2FF8A] flex flex-col justify-center border-black border">
          <svg width="87" height="39" viewBox="0 0 87 39" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto">
            <path d="M26.0348 38.4C40.8188 29.472 71.9228 20.448 86.8988 19.392V19.008C71.6348 17.952 40.2428 8.832 26.0348 0.191998L25.4588 0.959999C27.2828 6.816 31.7948 14.208 35.6348 18.24L0.11475 15.936V22.464L35.6348 20.352C31.8908 24.288 27.4748 31.488 25.4588 37.632L26.0348 38.4Z" fill="black"/>
          </svg>
        </div>
