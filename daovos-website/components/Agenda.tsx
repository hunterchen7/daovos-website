...
const Agenda = (): JSX.Element => {
  return (
    <div className="w-[95vw] mt-8" id="agenda">
      <div className="text-6xl bg-[url('../public/AGENDA.svg')] text-center py-8 mb-8" />
      <div className="border-t-2 border-black"/>
      <div className="text-[200px] font-bold text-center bg-[#E2FF8A] mt-12 py-12">
        AGENDA
      </div>
      <div className="items-center">
        ...
        <div className="flex flex-col justify-center text-center self-center items-center text-2xl pb-80 bg-[url('../public/BALL.svg')] border-b-2 border-black">
